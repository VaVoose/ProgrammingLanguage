...
#Constant values to access the different values stored in token
LINENUMBER = 0
VALUE = 1
CATEGORY = 2
...
class Parse:
    ...
    <Type> --> int | bool | float | char
               ^^^^^^^^^^ one of the above
    Called from <declaration> or <primary>
    '''
    def Type(self):
    ...
    <statement> --> ; | <block> | <assignment> | <iftstatement> | <whilestatement>
                   ^^^^One of the above
    Called from <statements> or <ifstatement> or <whilestatement>
    '''
    def statement(self):
    ...
    <expression> --> <Conjunction>    || <Conjunction>
                                    ^^^^^Repeatable
    Called from <assignment> or <ifstatement> or <whilestatement> or <primary>
    '''
    def expression(self):
    ...
    #                           ^^^^^^^^Repeatable
    Check token category from lexer
    Called from <declaration> or <assignment> or <primary>
    '''
    def identifier(self):
    ...
    <letter> --> a | b | ... | z | A | B | .... | Z
             ^^^^^one of the above
    Not Called (Letter is already performed in the lexer)
    '''
    def letter(self):
    ...
    <digit> --> 1 | 2 | 3 | ... | 9
             ^^^^^one of the above
    Not called (Digit is already performed in the lexer)
    '''
    def digit(self):
    ...
    <integer> --> <Digit>    <Digit>
                           ^^^^Repeatable    
    Check token category from lexer    
    Called from <declaration> or <literal>
    '''
    def integer(self):
